...
describe '#binary_multiple_of_4?' do
  ...
  it 'classifies valid binary numbers [30 points]' , points: 30 do
    ...
    %w[001 1000000000001].each do |string|
  ...
  it 'rejects invalid binary numbers [10 points]' , points: 10 do
    ...
    expect(binary_multiple_of_4?('10v30')).to be_falsy, "'a100' is not a valid binary number!"
    expect(binary_multiple_of_4?('34100')).to be_falsy, "'a100' is not a valid binary number!"
    expect(binary_multiple_of_4?('#$100')).to be_falsy, "'a100' is not a valid binary number!"
    expect(binary_multiple_of_4?('a100')).to be_falsy, "'a100' is not a valid binary number!"
